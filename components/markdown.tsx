...
const Ol: OrderedListComponent = ({
  children = '',
  ...properties
}) => (
  <ol {...properties} className="sm:text-xl text-lg my-4 list-decimal pl-10 dark:text-gray-300"
  >{children}</ol>
)

const Ul: UnorderedListComponent = ({
  children = '',
  ...properties
}) => (
  <ul {...properties} className="sm:text-xl text-lg list-disc pl-5 my-5 dark:text-gray-300"
  >{children}</ul>
)

const Del: React.FC<Pick<DetailedHTMLProps<DelHTMLAttributes<HTMLModElement>, HTMLModElement>, 'key' | keyof DelHTMLAttributes<HTMLModElement>> & ReactMarkdownProps> = ({
  children,
  ...properties
}) => (
  <span {...properties}
...
const Em: React.FC<Pick<DetailedHTMLProps<HTMLAttributes<HTMLElement>, HTMLElement>, 'key' | keyof HTMLAttributes<HTMLElement>> & ReactMarkdownProps> = ({
  children,
  ...properties
}) => (
...
const P: React.FC<Pick<DetailedHTMLProps<HTMLAttributes<HTMLParagraphElement>, HTMLParagraphElement>, 'key' | keyof HTMLAttributes<HTMLParagraphElement>> & ReactMarkdownProps> = ({
  children,
  ...properties
}) => (
...
const A: React.FC<Pick<DetailedHTMLProps<AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>, 'key' | keyof AnchorHTMLAttributes<HTMLAnchorElement>> & ReactMarkdownProps> = ({
  children,
  ...properties
}) => (
  <a {...properties}
    className="text-blue-500 hover:text-blue-800 after:content-['_↗'] transition-colors duration-200"
  >{children}</a>
)

const Strong: React.FC<Pick<DetailedHTMLProps<HTMLAttributes<HTMLElement>, HTMLElement>, 'key' | keyof HTMLAttributes<HTMLElement>> & ReactMarkdownProps> = ({
  children,
  ...properties
}) => (
...
const BlockQuote: React.FC<Pick<DetailedHTMLProps<BlockquoteHTMLAttributes<HTMLQuoteElement>, HTMLQuoteElement>, 'key' | keyof BlockquoteHTMLAttributes<HTMLQuoteElement>> & ReactMarkdownProps> = ({
  children,
  ...properties
}) => (
  <blockquote {...properties}
    className="border-l-4 pl-4 border-gray-300 dark:border-gray-600 rounded-l-sm italic my-4"
  >{children}</blockquote>
)
...
const Table: React.FC<Pick<DetailedHTMLProps<TableHTMLAttributes<HTMLTableElement>, HTMLTableElement>, 'key' | keyof TableHTMLAttributes<HTMLTableElement>> & ReactMarkdownProps> = ({
  ...
  <table {...properties} className="sm:w-11/12 w-full text-lg mx-auto px-2 my-3 dark:text-gray-300"
  >{children}</table>
)

const THead: React.FC<Pick<DetailedHTMLProps<HTMLAttributes<HTMLTableSectionElement>, HTMLTableSectionElement>, 'key' | keyof HTMLAttributes<HTMLTableSectionElement>> & ReactMarkdownProps> = ({
  children,
  ...properties
}) => (
  <thead {...properties} className="font-bold border-solid bg-gray-100 dark:bg-gray-900"
  >{children}</thead>
)

const Tbody: React.FC<Pick<DetailedHTMLProps<HTMLAttributes<HTMLTableSectionElement>, HTMLTableSectionElement>, 'key' | keyof HTMLAttributes<HTMLTableSectionElement>> & ReactMarkdownProps> = ({
  children,
  ...properties
}) => (
...
const Td: TableDataCellComponent = ({children = ''}) => <td
  className="border-solid border-x-2 border-y-2 dark:border-gray-900"
>{children}</td>

const Th: TableHeaderCellComponent = ({children = ''}) => <th
  className="border-solid border-x-2 border-y-2 dark:border-gray-900"
>{children}</th>
